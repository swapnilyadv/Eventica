...
```css
git remote add upstream https://github.com/Rakesh9100/Eventica.git
```
...
1. Please follow our project's [Code of Conduct](https://github.com/Rakesh9100/Eventica/blob/main/.github/CODE_OF_CONDUCT.md) while contributing.
2. Treat all contributors and users with respect and create a positive and inclusive environment for everyone.</p>

<h2>⚡ License</h2>

1. The project is licensed under [Apache-2.0 license](https://github.com/Rakesh9100/Eventica/blob/main/LICENSE). Make sure to review and comply with the license terms.
